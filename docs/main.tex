...
%Inserte grafico de best y worst case aqui

Como se puede ver, efectivamente la diferencia de complejidad es evidente entre estos casos. Aunque no es una diferencia mayor.
